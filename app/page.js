  ...
  return (
    <>
      ...
      <Hero title={`We Design & Build <br /> <i>High-Performance</i><br />  Digital Products`}
        ...
        <Button text="Explore our services" variant="primary"><ArrowRight className='size-20' /></Button>
        <Button text="Book a Free Consulation" variant="secondary"><Phone className='size-20' /></Button>
      </Hero>
